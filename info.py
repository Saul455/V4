...
BOT_TOKEN = environ.get('BOT_TOKEN', "7521755373:AAF47Y1KtItIWhJ8aV18VQ_HsEjavXvpwsU")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/Cez.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6831947029').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002124030786').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002126301273') # give your force subscribe channel id here else leave it blank
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Sail:Saul@cluster0.xc1bu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Ghostparadis3') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+l9jNeG2OCiE0YTQ1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/SigmaDestiny')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/+gRJCrS6hpqZlYTg1') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '7337a3f2a82cc5d7060bb10a12127f68c89d5d33')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', '')

# If You Fill Second Shortner Then Bot Attach Both First And Second Shortner And Use It For Verify.
VERIFY_SECOND_SHORTNER = bool(environ.get('VERIFY_SECOND_SHORTNER', True))
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'bindaaslinks.com')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '49ff923da91ec127edca47fe22d4d2d8d7514669')
